    ...
    <div className="grid grid-cols-1 w-full items-center container mx-auto max-w-3xl justify-center h-full gap-9">
      <Card className="col-span-3 flex flex-col gap-5 p-5 ">
        <Typography variant="h4" className="text-primary">
          ...
          <p className="text-sm">以下の注意事項をご確認の上、富士紡GPTのご利用をお願いいたします。詳細はマニュアルをご参照下さい。<br/></p>
          <p style={font_style} className="text-sm">※富士紡GPTで質問した内容は、外部に漏れないようにセキュリティ対策を行っております</p>
          <br/>
